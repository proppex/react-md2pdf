...
const pureHtmlText = `
<p class=\"PlaygroundEditorTheme__paragraph\" dir=\"ltr\" style=\"text-indent: 20px;\"><span style=\"white-space: pre-wrap;\">Lastly, we're constantly adding cool new features to this playground. So make sure you check back here when you next get a chance. Lastly, we're constantly adding cool new features to this playground. </span></p><p class=\"PlaygroundEditorTheme__paragraph\" dir=\"ltr\"><br></p><p class=\"PlaygroundEditorTheme__paragraph\" dir=\"ltr\"><span style=\"white-space: pre-wrap;\">So make sure you check back here when you next get a chance.Lastly, we're constantly adding cool new features to this playground. So make sure you check back here when you next get a chance.Lastly, we're constantly adding cool new features to this playground. So make sure you check back here when you next get a chance.{{Tenant_First_Name}}{{Tenant_Last_Name}}</span></p>`;
